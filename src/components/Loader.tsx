...
const Loader = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-2">
      ...
      <div
        className="relative w-[7.5em] h-[7.5em] rounded-full border-[0.15em] border-white overflow-hidden"
        style={{
      ...
      >
        ...
        {[0, 1, 2, 3].map((i) => (
          <svg
            ...
            viewBox="0 0 200 200"
            className="absolute w-[7em]"
            style={{
              bottom: i === 0 || i === 3 ? (i === 0 ? '-2em' : '-2.2em') : undefined,
              top: i === 1 ? '-3em' : i === 2 ? '-2.5em' : undefined,
      ...
      <p className="text-white text-lg pt-1 font-sans">Fetching Global News...</p>
    </div>
  );
};
