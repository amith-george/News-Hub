...
// Compute otherCategories once here, so you can import it too if needed
export const otherCategories = allCategories.filter(
  (cat) => !mainCategories.includes(cat)
)

// Countries with codes; only first letters capitalized
